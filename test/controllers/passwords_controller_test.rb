...
class PasswordsControllerTest < ActionController::TestCase
  ...
  test "should create password" do
    assert_difference('Password.count') do
      post :create, password: { password: @password.password, room_id: @password.room_id, user_id: @password.user_id }
    end
  ...
  test "should update password" do
    patch :update, id: @password, password: { password: @password.password, room_id: @password.room_id, user_id: @password.user_id }
    assert_redirected_to password_path(assigns(:password))
  end
